...
func (x *MErrorToc) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MErrorToc) ProtoMessage() {}

func (x *MErrorToc) ProtoReflect() protoreflect.Message {
	mi := &file_pb_common_proto_msgTypes[0]
...
// Deprecated: Use MErrorToc.ProtoReflect.Descriptor instead.
func (*MErrorToc) Descriptor() ([]byte, []int) {
	return file_pb_common_proto_rawDescGZIP(), []int{0}
}

func (x *MErrorToc) GetErrorCode() int32 {
...
func (x *MErrorToc) GetArgs() string {
	if x != nil && x.Args != nil {
		return *x.Args
	}
	return ""
...
var file_pb_common_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x62, 0x0a, 0x0b, 0x6d, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x74, 0x6f, 0x63,
	...
	0x65, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a, 0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x01, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x88, 0x01, 0x01, 0x42, 0x0d, 0x0a,
	0x0b, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x42, 0x07, 0x0a, 0x05,
	0x5f, 0x61, 0x72, 0x67, 0x73, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
func file_pb_common_proto_init() {
	...
	file_pb_common_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
